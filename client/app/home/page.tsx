      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-[#71717a] mt-1">Collaborate with your research teams</p>
          </div>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-[#71717a]">Loading your groups...</p>
          </div>
        ) : filteredGroups.length === 0 ? (
          <div className="text-center py-20">
            <div className="w-24 h-24 bg-[#1a1a1a] rounded-2xl flex items-center justify-center mx-auto mb-6 border border-[#2a2a2a]">
              <Users size={40} className="text-[#52525b]" />
            </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-[#2a2a2a] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#14FFEC]/40 focus:border-[#14FFEC] resize-none bg-[#1a1a1a] text-white placeholder:text-[#52525b] transition-all hover:border-[#3a3a3a]"
                  rows={4}
                />
              </div>
            </div>
